...
urlpatterns = [
    ...
    path('whiskeys/search/suggest/', views.WhiskeySearchSuggestView.as_view(), name='whiskey-search-suggest'),
    path('whiskeys/search/', views.WhiskeySearchView.as_view(), name='whiskey-search'),
