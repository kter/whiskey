    ...
    <div class="max-w-md w-full space-y-8">
      ...
      <div class="mb-6">
        <button
          type="button"
          @click="googleSignIn"
          class="w-full flex justify-center items-center py-3 px-4 border border-gray-600 text-sm font-medium rounded-md text-gray-100 bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors"
        >
